...
class ConversationGAT(nn.Module):
    def __init__(self):
        ...
        self.lstm = nn.LSTM(
            input_size=768, hidden_size=128, num_layers=2, dropout=0.5, bidirectional=True, batch_first=True
        )
    ...
    def forward(self, data: Data) -> torch.Tensor:
        ...
        x = self.gat(x=x, edge_index=edge_index, edge_attr=edge_attr[edge_index[0]] + edge_attr[edge_index[1]])
